            ...
            <div class="w-full sm:w-80">
                <a href="/public" class="block h-full group">
                    <div class="flex flex-col card p-8 items-center text-center h-full transition group-hover:-translate-y-1 group-hover:shadow-2xl group-hover:shadow-indigo-950/10">
                        ...
                        <h2 class="font-semibold font-mono text-2xl mt-6 text-slate-800 dark:text-white">Public Rooms</h2>
                        <span class="text-sm mt-2 text-slate-500 dark:text-slate-400 font-light">Join the public chat room</span>
                    </div>
                </a>
            </div>
            <div class="w-full sm:w-80">
                <a href="/private" class="block h-full group">
                    <div class="flex flex-col card p-8 items-center text-center h-full transition group-hover:-translate-y-1 group-hover:shadow-2xl group-hover:shadow-indigo-950/10">
                        ...
                        <h2 class="font-semibold font-mono text-2xl mt-6 text-slate-800 dark:text-white">Private Rooms</h2>
                        <span class="text-sm mt-2 text-slate-500 dark:text-slate-400 font-light">Create or join private chat rooms</span>
                    </div>
                </a>
            </div>
        </div>
