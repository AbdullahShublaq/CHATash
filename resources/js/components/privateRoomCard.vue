    ...
    <div class="m-4">
        <a :href="room.path">
            <div class="flex flex-col bg-white rounded-lg py-8 px-12 items-center shadow-lg border hover:border-blue-900">
                <h3 class="font-light font-mono text-lg text-blue-900" v-text="room.name"></h3>
                <div class="flex justify-center w-full mt-3">
                    <div class="flex items-center mx-2">
                        ...
                        <span class="font-semibold font-mono text-blue-900 ml-1" v-text="room.participantsCount"></span>
                    </div>
                    <div class="flex items-center mx-2">
                        ...
                        <span class="font-semibold font-mono text-green-500 ml-1" v-text="activePeerCount"></span>
                    </div>
                </div>
            </div>
        </a>
